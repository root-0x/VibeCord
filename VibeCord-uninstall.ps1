# ==============================================================================
#  VibeCord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection VibeCord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "VibeCord-Client"
...
Write-Host "  │  VibeCord désinstallé avec succès !                 │" -ForegroundColor Green
