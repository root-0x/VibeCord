...
import { Logger } from "@VibeCord/types/utils";
import { findLazy, onceReady } from "@VibeCord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@VibeCord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("VibeCordRPC", "#5865f2");
