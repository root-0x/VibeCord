...
import { Button, Flex, Heading, Paragraph } from "@VibeCord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@VibeCord/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        VibeCordFr is a 100% Free product.
                    </Paragraph>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download VibeCordFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
