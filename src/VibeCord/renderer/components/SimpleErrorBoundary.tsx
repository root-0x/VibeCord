...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@VibeCord/types/components";
import { FluxDispatcher, InviteActions } from "@VibeCord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure VibeCord and VibeCord are fully up to date. You can get help in our{" "}
