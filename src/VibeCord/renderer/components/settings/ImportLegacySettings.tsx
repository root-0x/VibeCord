...
function cleanForVibeCord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans VibeCord
...
export function ImportLegacySettingsButton({ settings }: { settings: any; }) {
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre VibeCord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into VibeCord.
                Plugin-specific settings that don't exist in VibeCord will be automatically removed.
            </BaseText>
