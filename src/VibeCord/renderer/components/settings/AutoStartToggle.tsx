...
import { useState } from "@VibeCord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start VibeCord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start VibeCord minimized when starting with system"}
