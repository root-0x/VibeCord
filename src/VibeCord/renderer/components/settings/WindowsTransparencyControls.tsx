...
import { Heading, Paragraph } from "@VibeCord/types/components";
import { Margins } from "@VibeCord/types/utils";
import { Select } from "@VibeCord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind VibeCord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
