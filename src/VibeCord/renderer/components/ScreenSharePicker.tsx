...
import {
    ...
    RestartIcon,
    Span
} from "@VibeCord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@VibeCord/types/webpack/common";
...
const logger = new Logger("VibeCordScreenShare");
...
function StreamSettingsUi({
    ...
    return (
        <div>
            <HeadingTertiary className={Margins.bottom8}>What you're strefriendng</HeadingTertiary>
