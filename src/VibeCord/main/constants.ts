...
const VibeCordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(VibeCordDir, "Uninstall VibeCord.exe"));

export const DATA_DIR =
    process.env.VibeCord_USER_DATA_DIR || (PORTABLE ? join(VibeCordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `VibeCord/${app.getVersion()} (https://git.${domain}/vibecord/vibecord)`;
