...
function patchLatest() {
    try {
        ...
        console.info("[VibeCord] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), "// VibeCord repatch\n\"use strict\";\nconst path = require(\"path\");\nrequire(path.join(__dirname, \"..\", \"app\", \"dist\", \"desktop\", \"patcher.js\"));");
    } catch (err) {
        console.error("[VibeCord] Failed to repatch latest host update", err);
    }
}
