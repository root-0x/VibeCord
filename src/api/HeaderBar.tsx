...
try { _stealthActive = localStorage.getItem("VibeCord_stealthMode") === "1"; } catch { }
...
function persistStealth(v: boolean) {
    try { v ? localStorage.setItem("VibeCord_stealthMode", "1") : localStorage.removeItem("VibeCord_stealthMode"); } catch { }
}
