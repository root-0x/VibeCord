...
let VibeCordBadges = {} as Record<string, Array<{ icon: string; placeholder: string; uuid: string; }>>;
...
export default definePlugin({
    ...
    getVibeCordBadges(userId: string) {
        try {
            const userBadges = VibeCordBadges[userId];
            ...
            return userBadges
                ...
                .map(badge => ({
                    iconSrc: badge.icon,
                    description: badge.placeholder ?? "VibeCord Badge",
                    position: BadgePosition.START,
                    props: {
                        style: {
                            borderRadius: "0%",
