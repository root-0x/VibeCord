...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the VibeCord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("VibeCord_stealthMode") === "1") return ""; } catch { }
                return "VibeCord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("VibeCord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`VibeCord ${gitHashShort}${getVersionInfo()}`];
