...
import { t } from "../autoTranslateVibeCord";
...
const LS_KEY_DATA = "VibeCordCP_data";
const LS_KEY_ENABLED = "VibeCordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "VibeCordCP_allData";
const LS_ALL_ENABLED = "VibeCordCP_allEnabled";
