/*
 * VibeCord – WorldBomb Assistant Plugin
...
import { WordBombOverlay, toggleWordBombOverlay } from "./WordBombOverlay";
import "./styles.css";
...
export default definePlugin({
    ...
    stop() {
        ...
        const container = document.getElementById("nc-wb-root");
