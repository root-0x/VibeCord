...
async function checkForUpdates() {
    try {
        ...
        console.log(`[VibeCordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[VibeCordUpdater] Error:", e);
    }
}
...
function mountBanner() {
    ...
    try {
        ...
        console.error("[VibeCordUpdater] Error mounting banner:", e);
    }
}
