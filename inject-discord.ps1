# ==============================================================================
#  VibeCord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter VibeCord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de VibeCord
$VibeCordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$VibeCordPatcher = $VibeCordPatcher.Replace("\", "\\")
...
// Injection VibeCord
try {
    require(\"$VibeCordPatcher\");
} catch (e) {
    console.error(\"VibeCord injection failed:\", e);
