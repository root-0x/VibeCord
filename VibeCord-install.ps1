# ==============================================================================
#  VibeCord — Installeur utilisateur (PowerShell autonome)
#  
#  Ce script fait TOUT automatiquement :
#  1. Télécharge EquilotlCli.exe (outil d'injection graphique)
#  2. Télécharge les fichiers VibeCord compilés depuis GitHub
#  3. Lance l'interface graphique pour choisir votre Discord cible
#  4. Injecte VibeCord dans Discord
#
...
# ── [2/3] Télécharger les fichiers VibeCord ──────────────────────────────────
Write-Step 2 3 "Téléchargement des fichiers VibeCord depuis GitHub..."

try {
    $apiUrl   = "https://api.github.com/repos/$VibeCordRepo/releases/latest"
    ...
    Write-OK "VibeCord $version prêt à être injecté !"
} catch {
    Write-Fail "Échec du téléchargement VibeCord.`n           Détail : $_"
}
...
Write-Host "          │  Sélectionnez le Discord où injecter VibeCord. │" -ForegroundColor DarkCyan
Write-Host "          └─────────────────────────────────────────────────┘" -ForegroundColor DarkCyan
Write-Host ""
...
Write-Host "  ║  VibeCord installé avec succès !                    ║" -ForegroundColor Green
Write-Host "  ║                                                      ║" -ForegroundColor Green
