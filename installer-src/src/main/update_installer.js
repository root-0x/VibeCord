...
const getJSON = phin.defaults({
    method: "GET",
    parse: "json",
    headers: {"User-Agent": `VibeCord Installer/${version}`},
    ...
    try {
        ...
        if (semverGreaterThan(latestVersion, version)) {
            ...
            const result = await dialog.showMessageBox({
                ...
                message: `A new version of the VibeCord installer is available. Click "Download" to download the newest version.`,
